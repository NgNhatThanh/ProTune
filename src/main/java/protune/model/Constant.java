...
public class Constant {
    ...
    static public final String facebookIconPath = "src/main/resources/img/facebook.png";
    ...
    static public final String playlistIconPath = "src/main/resources/img/playlist.png";
